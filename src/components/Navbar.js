    ...
    <div className="navbar navbar-expand-lg navbar-dark bg-white sticky-top ">
      ...
      <div class="collapse navbar-collapse " id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
          <li class="nav-item">
            <a class="nav-link text-dark navbarItem" href="/">
              Ana Sayfa{' '}
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link text-dark navbarItem" type="button" href="/login">
              Dersler
            </a>
          </li>
          <li class="nav-item">
            <a
              class="nav-link text-dark navbarItem"
          ...
          <li class="nav-item dropdown">
            <a
              class="nav-link dropdown-toggle text-dark navbarItem"
